...
import (
	...
	"os"
	"strings"
	"terraform-provider-azurecm/clients"
	"terraform-provider-azurecm/helpers"
	"terraform-provider-azurecm/helpers/utils"
	"terraform-provider-azurecm/resourceproviders"
	"terraform-provider-azurecm/services/web"
...
func azureProvider(supportLegacyTestSuite bool) terraform.ResourceProvider {
	p := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"azurecm_function_host_secret": web.ResourceFunctionAppHostSecret(),
		},
		DataSourcesMap: map[string]*schema.Resource{
			"azurecm_function_host_secret": web.DataSourceFunctionHostKey(),
		},
	}
